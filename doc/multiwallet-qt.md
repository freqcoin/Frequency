...
In order to support loading of multiple wallets in frequency-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is frequency.cpp.
...
Changes to frequency.cpp
----------------------
frequency.cpp is the entry point into frequency-qt, and as such, will require some minor modifications to provide hooks for
