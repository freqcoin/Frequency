...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextFrequency = QChar(0xA9) + QString(" 2022 ").arg(COPYRIGHT_YEAR) + QString(tr("The Frequency developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextFrequency);
