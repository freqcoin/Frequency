...
// Copyright (c) 2022 The Frequency developers
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Frequency features */
        {"frequency", "masternode", &masternode, true, true, false},
        {"frequency", "listmasternodes", &listmasternodes, true, true, false},
        {"frequency", "getmasternodecount", &getmasternodecount, true, true, false},
        {"frequency", "masternodeconnect", &masternodeconnect, true, true, false},
        {"frequency", "masternodecurrent", &masternodecurrent, true, true, false},
        {"frequency", "masternodedebug", &masternodedebug, true, true, false},
        {"frequency", "startmasternode", &startmasternode, true, true, false},
        {"frequency", "createmasternodekey", &createmasternodekey, true, true, false},
        {"frequency", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"frequency", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"frequency", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"frequency", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"frequency", "getmasternodescores", &getmasternodescores, true, true, false},
        {"frequency", "mnbudget", &mnbudget, true, true, false},
        {"frequency", "preparebudget", &preparebudget, true, true, false},
        {"frequency", "submitbudget", &submitbudget, true, true, false},
        {"frequency", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"frequency", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"frequency", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"frequency", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"frequency", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"frequency", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"frequency", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"frequency", "checkbudgets", &checkbudgets, true, true, false},
        {"frequency", "mnsync", &mnsync, true, true, false},
        {"frequency", "spork", &spork, true, true, false},
        {"frequency", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"frequency", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use frequencyd, or the -server option to frequency-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
